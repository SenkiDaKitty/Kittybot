...
bot.on('message', async message => {
    ...
    if (message.content === prefix + "staff"){
        var embed = new Discord.RichEmbed()
            ...
            .setAuthor("Asked By, Demandé Par : " + message.author.username,message.author.avatarURL)
            .addField("<a:MeowDance:460163260780380170> __***Administrateur***__ ","キティSєηKιTheKitty : <:minecraft:482269570959278091> : MyaTK (**Premium**), JS :computer: <:JS:483747345972985857>", true)
