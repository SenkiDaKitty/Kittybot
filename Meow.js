...
bot.on('message', async message => {
    ...
    if (message.content === prefix + "staff"){
        var embed = new Discord.RichEmbed()
            ...
            .setAuthor("Asked By, Demandé Par : " + message.author.username,message.author.avatarURL)
            .addField("<a:MeowDance:460163260780380170> __***Administrateur***__ ","キティSєηKιTheKitty : <:minecraft:482269570959278091> : MyaTK (**Premium**), JS :computer: <:JS:483747345972985857> | <:elie:503106045145513987> Elie", true)
            ...
            .addField("<:right:479601398456123423> **Verified +++**",` <:JS:483747345972985857> : Wright | ElTHumeau | LordMorgoth | <:King:503566430864932886> King.`)
            ...
            .addField("<:rightgreen:482294137505185842> **Verified**",` Lighti. `)
            .setColor("0xff00ff")
